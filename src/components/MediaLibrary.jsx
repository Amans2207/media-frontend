            ...
            >
              ...
              <div className="p-4 flex-1 flex flex-col justify-between">
                ...
                <div className="flex gap-2 mt-4 flex-wrap">
                  <a href={`https://frugality-unhidden-tibia.ngrok-free.dev/api/serve/${item.filename}`} download className="px-4 py-2 bg-white/10 hover:bg-white/20 text-sm rounded-lg transition-colors flex items-center gap-2">
        ...
        {playingFile && (
          ...
          >
            ...
            >
              ...
              <video 
                src={`https://frugality-unhidden-tibia.ngrok-free.dev/api/serve/${playingFile}`} 
                controls 
                autoPlay 
